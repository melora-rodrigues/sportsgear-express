                            ...
                            <form action="./controller/logreg.php" method="POST" class="pt-3"
                                ...
                                <div class="d-flex" style="gap:2%">
                                    ...
                                    <div class="form-group w-100">
                                        ...
                                        <input name="profile" type="file" class="form-control form-control-lg"
                                            id="exampleInputEmail1" placeholder="Profile Picture"
                                ...
                                <div class="d-flex" style="gap:2%">
                                    ...
                                    <div class="form-group w-100">
                                        ...
                                        <textarea name="address" type="text" class=" form-control form-control-lg"
